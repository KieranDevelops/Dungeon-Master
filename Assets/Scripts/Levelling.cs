...
public class Levelling : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("Attack lvl is: " + attack);//Debug out player attack
        Debug.Log("Defense lvl is: " + defense);//Debug out player defense
        Debug.Log("Luck lvl is: " + luck);//Debug out player luck
